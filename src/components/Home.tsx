...
const Home = (props: any) => {
  ...
  const handleLogout = () => {
    fetch(`https://api.endlessmedicaladvantage.org/admin_api/logout`, {
      method: 'POST',
      headers: {
        Authorization: token
      },
  ...
  const deleteUser = async (email: string): Promise<any> => {
    const response = await fetch(`https://api.endlessmedicaladvantage.org/admin_api/user`, {
  ...
  const getUsers = async (): Promise<User[]> => {
    const response = await fetch(`https://api.endlessmedicaladvantage.org/admin_api/all_users`, {
      method: 'GET',
      headers: {
        Authorization: token
      }
